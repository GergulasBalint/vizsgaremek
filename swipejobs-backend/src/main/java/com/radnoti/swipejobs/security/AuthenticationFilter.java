...
import com.radnoti.swipejobs.SpringApplicationContext;
import com.radnoti.swipejobs.service.UserService;
import com.radnoti.swipejobs.shared.dto.UserDto;
import com.radnoti.swipejobs.ui.model.request.UserLoginRequestModel;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        res.addHeader("user_type", String.valueOf(userDto.getUser_type()));
        ...
        String responseBody = "{\"token\": \"" + token + "\", \"id\": \"" + userDto.getId() + "\",\"user_type\":\""+userDto.getUser_type()+"\"}";
